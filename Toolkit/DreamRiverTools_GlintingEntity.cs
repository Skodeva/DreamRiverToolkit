...
public class DreamRiverTools_GlintingEntity : MonoBehaviour
{
    ...
    /// 闪烁颜色
    /// </summary>
    [Header("闪烁的颜色")] public Color color = new(61 / 255f, 226 / 255f, 131 / 255, 1);

    /// <summary>
    /// 最低发光亮度，取值范围[0,1]，需小于最高发光亮度。
    /// </summary>
    [Header("最低发光亮度，取值范围[0,1]")] [Range(0.0f, 1.0f)]
    public float minBrightness;

    /// <summary>
    /// 最高发光亮度，取值范围[0,1]，需大于最低发光亮度。
    /// </summary>
    [Header("最高发光亮度，取值范围[0,1]")] [Range(0.0f, 1)]
    public float maxBrightness = 0.5f;

    //是否闪烁
    [HideInInspector] public bool isGlinting;
